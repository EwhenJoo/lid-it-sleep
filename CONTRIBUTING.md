...
Run `./Test-ClamshellSleep.ps1` before submitting code. Tests must not change the host's power settings or put it to sleep. Keep hardware observations separate from mocked test results.
